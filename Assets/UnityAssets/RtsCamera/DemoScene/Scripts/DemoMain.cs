...
public class DemoMain : MonoBehaviour
{
    ...
    private static void SetWalkerName(GameObject walker, string walkerName)
    {
        ...
        walker.transform.Find("NameTag").GetComponent<Text>().text = walkerName;
    }
    ...
    {
        t.Find("Selection Projector").GetComponent<Projector>().enabled = enable;
        t.Find("NameTag").GetComponent<Text>().enabled = enable;
    }
