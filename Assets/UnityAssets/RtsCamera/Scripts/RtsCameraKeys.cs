...
public class RtsCameraKeys : MonoBehaviour
{
    ...
    protected void Update()
    {
        ...
        if (AllowMove && (!_rtsCamera.IsFollowing || MovementBreaksFollow))
        {
            ...
            {
                hasMovement = true;
                _rtsCamera.AddToPosition(h * speed, 0, 0);
            }
            ...
            {
                hasMovement = true;
                _rtsCamera.AddToPosition(0, 0, v * speed);
            }
        ...
        if (AllowZoom)
        {
            if (ZoomUsesInputAxis)
            {
                ...
                {
                    _rtsCamera.Distance += zoom * ZoomSpeed / 10;
                }
            }
            else
            {
                ...
                {
                    _rtsCamera.Distance += ZoomSpeed / 10;
                }
